...
"Overview\n"
"--------\n"
"Some features may be built directly into Project.\n"
...
"------------------------------\n"
"If you prefer to have all of the Project options listed in a single\n"
...
load_config_help[] = N_(
	"\n"
	"For various reasons, one may wish to keep several different Project\n"
...
save_config_help[] = N_(
	"\n"
	"For various reasons, one may wish to keep different Project\n"
	"configurations available on a single machine.\n"
	"\n"
...
int main(int ac, char **av)
{
	...
	sym_calc_value(sym);
	sprintf(menu_backtitle, _("Project Configuration"));
	...
	do {
		cprint_init();
		cprint("--yesno");
		cprint(_("Do you wish to save your new Project configuration?"));
		cprint("5");
		cprint("60");
		stat = exec_conf();
	} while (stat < 0);
	...
	if (stat == 0) {
		if (conf_write(NULL)) {
			fprintf(stderr, _("\n\n"
				"Error during writing of the Project configuration.\n"
				"Your Project configuration changes were NOT saved."
				"\n\n"));
			return 1;
		}
		printf(_("\n\n"
